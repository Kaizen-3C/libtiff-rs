//! # libtiff-rs
//!
//! Memory-safe Rust port of the libtiff 4.7.0 **LZW decoder** (`LZWSetupDecode` +
//! `LZWPreDecode` + `LZWDecode` from tif_lzw.c) — libtiff's richest untrusted-input codec
//! surface: a 9-12-bit code-table decoder whose bounds guards are the LZW-overflow CVE
//! territory. Differentially certified against the upstream C build; see README.md.
